...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2024 at 01:11 PM
...
CREATE TABLE `bgmarr_tbl` (
  ...
  `bgmarr_status` varchar(20) NOT NULL
...
(1, 'BGMARR001', 'Forsaken (Classic, Spectre, Vandal, Operator, Blade), Oni 1 (Phantom)', 'https://drive.google.com/drive/folders/1wDZ23ucDWe0U8kl8rDcOE1TdTidvqduA', 'Ekurea_513', 'BGMARR002_221001', '10', 'BGMARR001_00000.jpg', 'Pending'),
(2, 'BGMARR002', 'Celestial (Fan), Ion 1 (Phantom), Magepunk 1 (Marshal), Oni 1 (Shorty), Prelude to chaos (Vandal), Protocol 781-A (Sheriff), Reaver 1 (Vandal, Operator), Recon (Ghost), RGX 11Z Pro 2 (Phantom), Sentinels of light (Sheriff), Sovereign (Stinger)', 'https://drive.google.com/drive/folders/1hivRjtLQ33MSYrhk_7u64XqqMz3JMI8J', 'Lllaw9', 'BGMARR003_141213', '10', 'BGMARR002_00000.jpg', 'UnAvailable'),
(3, 'BGMARR003', 'Glitchpop 2 (Classic, Phantom, Vandal, Operator, Axe), Origin (Frenzy), Prime 1 (Spectre), Prime 2 (Phantom)		', 'https://drive.google.com/drive/folders/1zf5UYDEgKeSYbOI-NRbwVxP0zm-YPhXN', 'venscarlet07', 'BGMARR006_120243', '10', 'BGMARR003_00000.jpg', 'UnAvailable'),
...
(5, 'BGMARR005', 'Ion 1 (Sheriff, Bucky, Phantom, Operator, Sword), Forsaken (Vandal), Oni 1 (Phantom), Reaver 1 (Operator)		', 'https://drive.google.com/drive/folders/1cpnLvm5_bqkB2b9dKnDxGPShiPZqBT6W', 'palmkan051060', 'BGMARR008_120244', '10', 'BGMARR005_00000.jpg', 'Pending'),
(6, 'BGMARR006', 'BlastX (Phantom), Elderflame (Judge), Glitchpop 1 (Frenzy), Glitchpop 2 (Vandal), Oni 1 (Guardian, Phantom, Claw), Prime 1 (Spectre), Prism (Spectre, Operator), Spline (Operator)		', 'https://drive.google.com/drive/folders/1bIjm7zpD57jgVDQGVLqnAYIUHWi-kK--', 'FiatZoGood', 'BGMARR009_142537', '10', 'BGMARR006_00000.jpg', 'Available'),
...
(16, 'BGMARR020', 'Champions 2022 (Phantom, Knife), Elderflame (Operator), Glitchpop 1 (Judge), Origin (Vandal), Prime 1 (Guardian), Protocol 781-A (Spectre), Reaver 1 (Sheriff)', 'https://drive.google.com/drive/folders/12BJfzrX5wrqLEh2fWgpwjaeQUy6eV9jc', 'Peachhub11', 'BGMARR029_120251', '15', 'BGMARR020_00000.jpg', 'Pending'),
...
(20, 'BGMARR025', 'Spectrum (Classic, Bulldog, Guardian, Phantom, Melee), Arcane (Sheriff), Forsaken (Vandal), Oni 1 (Phantom), Origin (Operator), Singularity (Sheriff)		', 'https://drive.google.com/drive/folders/1NCyLPZW_Jh89kZoHqfujQTvdkYOksVNQ', 'beck0203', 'BGMARR037_252347', '15', 'BGMARR025_00000.jpg', 'UnAvailable'),
...
INSERT INTO `id_order` (`id`, `id_order`, `session_user_id`, `user_id`, `id_bgmarr_name`, `price`, `quantity_hr`, `discount`, `date_order`, `order_status`) VALUES
(99, '2402000467', 'hrh0dvsig6n8oec3v9crrpjgld', '3', 'BGMARR013', '10', '1', 0, '2024-02-18 12:06:26', 'UnComplete');
