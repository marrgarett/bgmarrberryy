<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                ...
                <!-- <div class="sidebar-brand-text mx-3">BGMarrBerryy</div> -->
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse hide" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <div class="sidebar-card d-none d-lg-flex">
                ...
                <p class="text-center mb-2"><strong>SB Admin Pro</strong> is packed with premium features, จัดการข้อมูลต่างๆ, and more!</p>
