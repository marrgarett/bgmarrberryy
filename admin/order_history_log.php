        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    WHERE history_tbl.bgmarr_name = '$bgmarr_name' AND history_tbl.his_status = 'Complete'";
                    ...
                    <h1 class="h3 mb-4 text-gray-800">Rental history of ID Name <?php echo $_GET['bgmarr_name']; ?></h1>
                    <div class="card">
                        <div class="card-body">
